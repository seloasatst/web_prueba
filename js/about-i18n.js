window.I18N_PAGE_TRANSLATIONS = {
  ...
  es: {
    about: {
      ...
      values: {
        ...
        title: "Comprometidos en brindar soluciones integrales e innovadoras",
        description: "Superamos las expectativas de nuestros clientes ofreciendo soluciones ágiles y flexibles soportadas por un sistema de calidad, colaboradores competentes y procesos innovadores.",
        item_1: { title: "Seguridad", description: "Protocolos para minimizar riesgos de accidentes y daños o sustracción de insumos." },
        item_2: { title: "Calidad", description: "Cumplimiento de GMP's y GDP's con estructura robusta para preservar insumos." },
        item_3: { title: "Valor Agregado", description: "Modelos de servicio con precios justos y soluciones competitivas." },
  ...
  en: {
    about: {
      ...
      values: {
        kicker: "Our Values",
        title: "Committed to delivering comprehensive and innovative solutions",
        description: "We exceed our clients' expectations by offering agile and flexible solutions backed by a quality system, skilled collaborators, and innovative processes.",
        item_1: { title: "Security", description: "Protocols to minimize the risk of accidents and damage or theft of supplies." },
        item_2: { title: "Quality", description: "Compliance with GMP's and GDP's through a robust structure that preserves supplies." },
        item_3: { title: "Added Value", description: "Service models with fair pricing and competitive solutions." },
  ...
  al: {
    about: {
      ...
      values: {
        kicker: "Unsere Werte",
        title: "Verpflichtet, umfassende und innovative Lösungen zu liefern",
        description: "Wir übertreffen die Erwartungen unserer Kunden mit agilen und flexiblen Lösungen, unterstützt durch ein Qualitätssystem, kompetente Mitarbeitende und innovative Prozesse.",
        item_1: { title: "Sicherheit", description: "Protokolle zur Minimierung von Unfallrisiken sowie Schäden oder Diebstahl von Produkten." },
        item_2: { title: "Qualität", description: "Einhaltung von GMP's und GDP's mit einer robusten Struktur zum Schutz von Produkten." },
        item_3: { title: "Mehrwert", description: "Dienstleistungsmodelle mit fairen Preisen und wettbewerbsfähigen Lösungen." },
  ...
  pt: {
    about: {
      ...
      values: {
        ...
        title: "Comprometidos em oferecer soluções integrais e inovadoras",
        description: "Superamos as expectativas dos nossos clientes oferecendo soluções ágeis e flexíveis apoiadas por um sistema de qualidade, colaboradores competentes e processos inovadores.",
        item_1: { title: "Segurança", description: "Protocolos para minimizar riscos de acidentes e danos ou subtração de insumos." },
        item_2: { title: "Qualidade", description: "Cumprimento de GMP's e GDP's com estrutura robusta para preservar insumos." },
        item_3: { title: "Valor Agregado", description: "Modelos de serviço com preços justos e soluções competitivas." },
  ...
  fr: {
    about: {
      ...
      values: {
        kicker: "Nos Valeurs",
        title: "Engagés à offrir des solutions intégrales et innovantes",
        description: "Nous dépassons les attentes de nos clients en offrant des solutions agiles et flexibles, soutenues par un système qualité, des collaborateurs compétents et des processus innovants.",
        item_1: { title: "Sécurité", description: "Des protocoles pour minimiser les risques d'accidents, de dommages ou de vol de produits." },
        item_2: { title: "Qualité", description: "Respect des GMP's et GDP's grâce à une structure robuste pour préserver les produits." },
        item_3: { title: "Valeur Ajoutée", description: "Des modèles de service avec des prix justes et des solutions compétitives." },
